...
//                .foregroundColor(selectedTab == .rotate ? .blue : .black)
            ...
            CropView(selectedTab: $selectedTab, imageCropperShow: $imageCropperShow, ratio: $ratio)
                .frame(height: 160)
                .background(.orange)
...
var ratiosArray: [RatioType] = [
    RatioType(name: "original", value: 1.0),
    RatioType(name: "customize", value: 1.0),
    RatioType(name: "rectangle", value: 1.0),
    RatioType(name: "2:3", value: 0.67),
    RatioType(name: "3:2", value: 1.5),
    RatioType(name: "3:4", value: 0.75),
    RatioType(name: "4:3", value: 1.33),
    RatioType(name: "9:16", value: 0.5),
    RatioType(name: "16:9", value: 1.78)
]
